...
if (!comparativeReligionCategory.levels.intermediate || comparativeReligionCategory.levels.intermediate.length === 0) {
  comparativeReligionCategory.levels.intermediate = [...comparativeReligionCategory.levels.easy.slice(0, 10)]
}
