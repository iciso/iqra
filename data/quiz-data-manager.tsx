  ...
  },
  {
    ...
    levels: {
      easy: [
        ...
        options: ["Oneness of Allah", "Belief in angels", "Prophethood", "Day of Judgment"],
        correctAnswer: "Oneness of Allah",
        explanation: "Tawhid is the belief in the absolute oneness and uniqueness of Allah.",
    },
    {
        question: "How many categories of Tawhid are there in Islam?",
        options: ["One", "Two", "Three", "Four"],
        correctAnswer: "Three",
        explanation: "The three categories are Tawhid ar-Rububiyyah (Lordship), Tawhid al-Uluhiyyah (Worship), and Tawhid al-Asma' wa Sifat (Names and Attributes).",
    },
    {
        question: "What is the opposite of Tawhid?",
        options: ["Shirk", "Kufr", "Nifaq", "Fisq"],
        correctAnswer: "Shirk",
        explanation: "Shirk means associating partners with Allah, which is the greatest sin in Islam.",
    },
    {
        question: "Who is the Creator of everything?",
        options: ["Angels", "Prophets", "Allah", "Humans"],
        correctAnswer: "Allah",
        explanation: "Allah is the sole Creator and Sustainer of all existence.",
    },
    {
        question: "What is the first pillar of Iman (Faith)?",
        options: ["Belief in Allah", "Belief in angels", "Belief in books", "Belief in prophets"],
        correctAnswer: "Belief in Allah",
        explanation: "The first and most important pillar of Iman is believing in Allah's existence and oneness.",
    },
    {
        question: "Which of the following is a name of Allah?",
        options: ["Jibreel", "Ar-Rahman", "Iblees", "Firaun"],
        correctAnswer: "Ar-Rahman",
        explanation: "Ar-Rahman (The Most Merciful) is one of the beautiful names of Allah.",
    },
    {
        question: "What do Muslims believe about Allah's attributes?",
        options: ["They change", "They are perfect and eternal", "They are like humans", "They do not exist"],
        correctAnswer: "They are perfect and eternal",
        explanation: "Allah's attributes are perfect, unchanging, and unlike any creation.",
    },
    {
        question: "Which of these is a form of Shirk?",
        options: ["Praying to Allah", "Worshipping idols", "Helping the poor", "Fasting in Ramadan"],
        correctAnswer: "Worshipping idols",
        explanation: "Worshipping anything besides Allah, including idols, is Shirk.",
    },
    {
        question: "What is the meaning of 'La ilaha illallah'?",
        options: ["There is no god but Allah", "Allah is great", "Praise be to Allah", "Allah is one"],
        correctAnswer: "There is no god but Allah",
        explanation: "It is the declaration of Tawhid, affirming that only Allah deserves worship.",
    },
    {
        question: "Who was the first prophet sent to mankind?",
        options: ["Noah (Nuh)", "Adam (AS)", "Muhammad (SAW)", "Ibrahim (AS)"],
        correctAnswer: "Adam (AS)",
        explanation: "Prophet Adam was the first human and the first prophet.",
    },
    {
        question: "What is the greatest sin in Islam?",
        options: ["Lying", "Stealing", "Shirk", "Backbiting"],
        correctAnswer: "Shirk",
        explanation: "Shirk (associating partners with Allah) is the only unforgivable sin if not repented from.",
    },
    {
        question: "Which angel delivers Allah's revelations to prophets?",
        options: ["Mikail", "Israfil", "Jibreel", "Izrail"],
        correctAnswer: "Jibreel",
        explanation: "Angel Jibreel (Gabriel) is responsible for delivering divine messages.",
    },
    {
        question: "What is the purpose of human creation in Islam?",
        options: ["To enjoy life", "To worship Allah", "To gain power", "To collect wealth"],
        correctAnswer: "To worship Allah",
        explanation: "Allah says in the Quran: 'I did not create jinn and humans except to worship Me.' (51:56)",
    },
    {
        question: "Which book is the final revelation from Allah?",
        options: ["Torah", "Injeel", "Zabur", "Quran"],
        correctAnswer: "Quran",
        explanation: "The Quran is Allah's final and preserved revelation to Prophet Muhammad (SAW).",
    },
    {
        question: "What is the meaning of 'Al-Qayyum'?",
        options: ["The All-Knowing", "The Self-Sustaining", "The Forgiving", "The Creator"],
        correctAnswer: "The Self-Sustaining",
        explanation: "Al-Qayyum means Allah is self-sufficient and sustains all creation.",
    },
    {
        question: "Which prophet is known as the 'Father of Monotheism'?",
        options: ["Ibrahim (AS)", "Musa (AS)", "Isa (AS)", "Yusuf (AS)"],
        correctAnswer: "Ibrahim (AS)",
        explanation: "Prophet Ibrahim (AS) is called the father of monotheism for his unwavering belief in Tawhid.",
    },
    {
        question: "What is the meaning of 'Rabb'?",
        options: ["Prophet", "Lord", "Angel", "Messenger"],
        correctAnswer: "Lord",
        explanation: "Rabb means Lord, referring to Allah as the Creator and Sustainer.",
    },
    {
        question: "Which of these is a sign of Allah's existence?",
        options: ["Mountains", "Oceans", "Human creation", "All of the above"],
        correctAnswer: "All of the above",
        explanation: "Everything in the universe is a sign of Allah's power and existence.",
    },
    {
        question: "What is the punishment for Shirk in the Hereafter?",
        options: ["Temporary Hell", "No punishment", "Eternal Hell", "Reduced rewards"],
        correctAnswer: "Eternal Hell",
        explanation: "Allah warns that those who die upon Shirk without repentance will be in Hell forever.",
    },
    {
        question: "Which prophet was sent to every nation?",
        options: ["Only Muhammad (SAW)", "Noah (AS)", "Every nation had a prophet", "Only Musa (AS)"],
        correctAnswer: "Every nation had a prophet",
        explanation: "Allah sent messengers to every nation to guide them to Tawhid.",
    },
    {
        question: "What is the meaning of 'Al-Khaliq'?",
        options: ["The Provider", "The Creator", "The Judge", "The Merciful"],
        correctAnswer: "The Creator",
        explanation: "Al-Khaliq means 'The Creator,' referring to Allah as the One who creates everything.",
    },
    {
        question: "Which of these is NOT a form of worship in Islam?",
        options: ["Prayer (Salah)", "Charity (Zakat)", "Worshipping saints", "Fasting (Sawm)"],
        correctAnswer: "Worshipping saints",
        explanation: "Worship is only for Allah; worshipping saints or graves is Shirk.",
    },
    {
        question: "What is the meaning of 'Iman' in Islam?",
        options: ["Prayer", "Faith", "Charity", "Pilgrimage"],
        correctAnswer: "Faith",
        explanation: "Iman means faith, which includes belief in Allah, His angels, books, prophets, the Day of Judgment, and divine decree.",
    },
    {
        question: "Which of these is a characteristic of Allah?",
        options: ["He sleeps", "He needs rest", "He is All-Hearing", "He gets tired"],
        correctAnswer: "He is All-Hearing",
        explanation: "Allah is All-Hearing (As-Sami’), and He is free from human weaknesses.",
    },
    {
        question: "What is the key message of all prophets?",
        options: ["Build mosques", "Worship Allah alone", "Fight wars", "Write books"],
        correctAnswer: "Worship Allah alone",
        explanation: "All prophets called people to Tawhid—worshipping Allah alone without partners.",
    },
        {
