export default function QuizChallengesPage() {
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-2xl font-bold text-center mb-6">Demo IQRA Challenge</h1>
      <p className="text-center mb-8">
        This is a demo to test your Islamic knowledge against time and compete with others on our leaderboards.
      </p>
