...
import { 
  ArrowRight, ArrowLeft, Github, BookOpen, Database, Album, 
  Users, Clock, Trophy, Gamepad2, MessageSquare 
} from "lucide-react"
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
          <li>
            <strong>Concept, Design & Demo Version:</strong> by {" "}
              ...
              >
                Rafique
              </a>{" "}; and May Allah <span className="text-3xl font-normal align-middle">ﷻ</span>, <span>
              reward{" "}
